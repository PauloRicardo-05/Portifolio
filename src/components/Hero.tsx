    ...
    <section id="hero">
      <div className="container">
        <div className="hero-grid">
          ...
          <aside className="hero-photo"><img src="/img/FotoPaulo.jpeg" alt="Foto de Paulo Ricardo" id="hero-photo" /></aside>
        </div>
      </div>
    </section>
  );
